...
| Equirectangular Distortion Tool | The tool is an easy to use, and affordable way to generate 360 images using an equirectangular projection. 360 images are an accessible form of producing immersive experiences. They can be distributed easily on the web, with platforms such as Facebook and Youtube. We solved the technical challenge of the distortion of the equirectangular projection. | Python, MatPlotLib, Tkinter, NumPy              |
